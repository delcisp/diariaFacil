...
<div class="body bg-[#D6C9F2] grid justify-items-center">

    <form method="POST" action="{{ route('register') }}" >
        @csrf
        <div class=" grid mt-5 mb-5 me-2 bg-[#fff] rounded-lg border-4 border-[#705abf] w-fit "  >
      <div class="mx-2 border-b  border-purple-300/100 pb-8">

        <h2 class="mt-2 mb-1 grid justify-items-center font-semibold text-2xl leading-7 text-[#705ABF]">PERFIL CONTRATANTE </h2>
        <p class="mt-2 text-xl leading-6 text-[#B99AD9]">Bem vindo! Estamos ansiosos para lhe conhecer, preencha suas informações com cuidado. Te esperamos no DiáriaFácil!
        </p>
      ...
      <div class="mx-2 border-b mb-3 border-purple-300/100 pb-12">
        ...
        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <input id="usertype" name="usertype" type="text" placeholder="contratante" value="3" readonly required class="block w-full rounded-md border-0 py-1.5 text-[#B99AD9] shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400">
            </div>
          </div>
